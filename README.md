# 🏛️ Sistema de Registro, Acreditación QR y Control de Aforo (SEyD)

> **Versión:** `v1.0.0-GA`  
> **Plataforma:** .NET 9 ASP.NET Core / SQL Server / W3.CSS / HTML5 QR Scanner  
> **Estado CI/CD:** [![CI Build and Test (.NET 9)](https://github.com/al05088714/sistema-eventos-qr-seech/actions/workflows/ci.yml/badge.svg)](https://github.com/al05088714/sistema-eventos-qr-seech/actions)
...
7. [Roadmap (Planes Futuros / v2.0)](#roadmap-planes-futuros--v20)
...
1. Parametriza eventos y restringe el número de registros permitidos por Clave de Centro de Trabajo (CCT).
...
### 🛠️ Entorno de Desarrollo y Servidores
...
### 🔧 Instalación del Ambiente de Desarrollo Local
1. **Clonar el repositorio:**  
   `git clone https://github.com/al05088714/sistema-eventos-qr-seech`  
   `cd sistema-eventos-qr-seech`
2. **Restaurar paquetes NuGet:**  
   `dotnet restore`
3. **Configurar la cadena de conexión de Base de Datos** en `appsettings.Development.json`.
...
### ☁️ Implementación en Producción (Local / IIS / Nginx)
...
### 🛡️ Referencia para Usuario Administrador / Operador de Puerta
